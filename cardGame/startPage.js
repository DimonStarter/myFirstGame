...
function renderStartScreen() {
    ...
    buttonFirst.addEventListener('click', () => {
        ...
        if (buttonSecond.classList.contains('selected') || buttonThird.classList.contains('selected')) {
    ...
    buttonSecond.addEventListener('click', () => {
        ...
        if (buttonFirst.classList.contains('selected') || buttonThird.classList.contains('selected')) {
